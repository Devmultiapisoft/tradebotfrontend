...
export default function Header() {
  ...
  return (
    <>
      <div className="header-box d-flex p-ai-center" style={{backgroundColor: "#000000"}}>
        <div>
          <button
          ...
          <img src='https://cdn-icons-png.flaticon.com/512/4712/4712035.png' alt="Logo" className="img img-fluid logo" />
        </div>
